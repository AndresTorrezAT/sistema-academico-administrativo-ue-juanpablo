...
class ControladorDocentes{
    ...
    static public function ctrCrearDocente(){
        ...
        if(isset($_POST["nuevoNombre"])){
            ...
            if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) &&
               ...
               preg_match('/^[a-zA-Z]+$/', $_POST["nuevaFormacion"]) ){ 
    ...
    static public function ctrMostrarDocentesInfoUsuario($item, $valor){

        $tabla = "docente";

        $respuesta = ModeloDocentes::MdlMostrarDocentesInfoUsuario($tabla, $item, $valor);
    ...
    static public function ctrMostrarDocentesPorMateria($item, $valor){

        $tabla = "docente";

        $respuesta = ModeloDocentes::MdlMostrarDocentesPorMateria($tabla, $item, $valor);
